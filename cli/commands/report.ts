...
<footer style="border-top:1px solid #1f2937;padding:1.5rem 2rem;text-align:center;">
  <p style="color:#4b5563;font-size:0.8rem;">
    Generated by <a href="https://github.com/ai-guard-dev/eslint-plugin-ai-guard" style="color:#818cf8;text-decoration:none;">eslint-plugin-ai-guard</a> v${escHtml(data.version)}
    &nbsp;·&nbsp;
    <a href="https://github.com/ai-guard-dev/eslint-plugin-ai-guard" style="color:#818cf8;text-decoration:none;">GitHub</a>
  </p>
</footer>
